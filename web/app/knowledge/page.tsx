...
export default function KnowledgePage() {
  ...
  useEffect(() => {
    ...
    kbs.forEach((kb) => {
      ...
      const ws = new WebSocket(
        wsUrl(`/api/v1/knowledge/ws/progress?kb_name=${encodedKbName}`),
      );
  ...
  return (
    <div className="animate-fade-in h-screen overflow-y-auto p-6">
      ...
      {/* Toast Notification */}
      {toast && (
        <div className={`fixed bottom-6 right-6 z-[100] px-4 py-3 rounded-lg text-sm font-medium text-white shadow-lg animate-in fade-in slide-in-from-bottom-2 ${toast.type === "success" ? "bg-emerald-500 dark:bg-emerald-600" :
