...
const ALL_NAV_ITEMS: Record<string, { icon: LucideIcon; nameKey: string }> = {
  ...
  "/flashcard": { icon: GalleryVerticalEnd, nameKey: "Flashcards" },
  "/quiz": { icon: ClipboardList, nameKey: "Quiz" },
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            ...
            >
              ...
              <a
                href="https://hkuds.github.io/AdaptiveX/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-blue-500 dark:hover:text-blue-400 p-1.5 hover:bg-slate-100 dark:hover:bg-slate-700 rounded transition-colors"
                title={t("Visit AdaptiveX Homepage")}
              >
                <Globe className="w-4 h-4" />
              </a>
              <a
                href="https://github.com/HKUDS/AdaptiveX"
                target="_blank"
                rel="noopener noreferrer"
