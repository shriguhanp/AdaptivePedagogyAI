...
class AITutorStarter:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.error(str(e))
            logger.error("Please configure LLM settings in .env or AdaptiveX.env file")
            sys.exit(1)

        # Load knowledge base list
        self.available_kbs = self._load_available_kbs()

        logger.section("AdaptiveX Intelligent Teaching Assistant System")
